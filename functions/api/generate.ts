...
CURRENT UNACCEPTED SUGGESTED DOCUMENT

${requestData.suggestedDocument}
...
If you have enough information to create or revise the design, put a brief explanation in "message" and put the complete proposed design in "suggestedDocument".
  ...
  suggestedDocument: string;
    ...
    // This matches the AssistantResponse shape already used by the application.
    return Response.json({
        ...
        suggestedDocument:
            structuredResponse.suggestedDocument,
    });
};